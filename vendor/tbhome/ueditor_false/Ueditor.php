...
class Ueditor extends InputWidget
{
    ...
    public function run()
    {
        ...
        $js='var ue = UE.getEditor("'.$this->options['id'].'",'.$this->getOptions().');'.PHP_EOL.'ue.ready(function(){ue.execCommand('serverparam', {'uid': ''.$this->options['path'].'');});});';
        //Ueditor初始化脚本
