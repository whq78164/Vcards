...
<div class="wrap">
    ...
    <?php
    NavBar::begin([
        'brandLabel' => Yii::t('tbhome', 'Vcards886'),
//        'brandLabel' => ['label' => Yii::t('tbhome', 'Vcards'), 'class' => 'h1'],
    ...
    <div class="container">
        ...
        <a style="" href="<?php echo Yii::$app->urlManager->createUrl(['/site/language','lang'=>'zh-CN']);?>">中文886</a> /
        <a style="" href="<?php echo Yii::$app->urlManager->createUrl(['/site/language','lang'=>'en-US']);?>">English886</a>
        </span>
